...
const PRODUCTION_API_BASE_URL = 'https://timetoquiz.azurewebsites.net'; // to be changed to point to the URL of your API
...
const PRODUCTION_PATH_PREFIX = 'group-13-frontend-deployment-vinci'; // e.g. '/mymovies/' if you deploy to GitHub Pages as a Project site : mymovies would be the repo name
